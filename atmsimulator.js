...
const password3 = 4321;
let usersInfo = [
  ['Khvicha', 'Kvaratskhelia', balance1, password1],
  ['Merab', 'Dvalishvili', balance2, password2],
  ['Ilia', 'Topuria', balance3, password3]
];
...
function withdrawMoney(userIndex) {
  ...
  function depositMoney(userIndex) {
    ...
    if (amount > 1000000) {
        alert('დღიური ლიმიტი არის 50,000 ლარი,\n დარჩენილი თანხა გაანაღდეთ მომდევნო დღეს.');
        depositMoney(userIndex);
        return;
    }
    usersInfo[userIndex][2] += amount;
